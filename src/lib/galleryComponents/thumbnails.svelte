<!-- to create row of thumbnail images, image scrolled to will display in larger img box -->

<script lang="ts">
	import scrollCurrentIntoView from '$lib/actions/scrollCurrentIntoView';
...
<style lang="postcss">
	/* thank u Jhey Thompkins CodePen: https://codepen.io/jh3y/pen/mdxggmO 
