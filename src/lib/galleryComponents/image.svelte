<!-- create json file to put image info into -->
<!-- using Vite glob imports (ex: about/+page.Server.ts) makes it easier by finding all the jpgs (or pngs, my beloved), dont need to name every single one, plus its easier to change out the img set 
 	note: youd still need to update the json meta file if you change out some pics! -->
...
<!-- rel="preload" is a way of preloading img sets in chromium!! -->
<svelte:head>
 	<link
 		rel="preload" 
 		as="image"
